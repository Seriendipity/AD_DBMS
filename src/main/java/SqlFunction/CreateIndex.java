...
public class CreateIndex {
    ...
    //插入新数据后修改索引文件和B+树
    public static void updateIndexInsert(String DatabaseName,String TableName,String key,String value,String IndexFileName) throws DocumentException, IOException {
        for(int i = 0; i < treeList.size();i++){
            if(treeList.get(i).containsKey(TableName)){
    ...
    //更新数据后修改索引文件和B+树
    public static void updateIndexUpdate(String DatabaseName,String TableName,String key,String value,String IndexFileName) throws DocumentException, IOException {
        for(int i = 0; i < treeList.size();i++){
            if(treeList.get(i).containsKey(TableName)){
    ...
    //删除数据后修改索引文件和B+树
    public static void updateIndexDelete(String DatabaseName,String TableName,String key,String IndexFileName) throws DocumentException, IOException {
        //删除B+树节点
        for(int i = 0; i < treeList.size();i++){
            if(treeList.get(i).containsKey(TableName)){
